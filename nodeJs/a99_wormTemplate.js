...
// 基本域名
const BASE_HOST = "https://gbf.huijiwiki.com/wiki/"
const IMG_HOST = ""
// 下载开关
...
async function main() {
    start()
    // 取得一览列表
    let listUrl = BASE_HOST + "SSR%E4%BA%BA%E7%89%A9"
    // 发送请求,将响应内容写入文件
    const $ = await util.getTargetElementByAxios(listUrl, "", "templateList.html", true)
    // 开始取得一览 getListInfo($)
    let dataList = []
